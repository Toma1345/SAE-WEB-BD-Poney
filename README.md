...
Version finale du MCD : [lien Draw.io](https://drive.google.com/file/d/14vRvjKmsWGjzO7gUQmD7-Pgk-F7jJ_yY/view?ts=66f17a79)
...
Pour lancer facilement l'application vous pouvez exécuter la commande : `bash lancement.sh`
Là vous aurez le lien à ouvrir : `http://localhost:8000`
